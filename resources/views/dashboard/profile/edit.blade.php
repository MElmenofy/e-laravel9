                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">{{ __('Edit Profile') }}</h4>
                                        ...
                                        <form class="form" action="{{ route('update.profile') }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">{{ __('Name') }}</label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">{{ __('Email') }}</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">{{ __('New Password') }}</label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">{{ __('Password Confirmation') }}</label>
                                                            <input type="password" value="" id="password"
                                                                   class="form-control"
                                                                   placeholder="password"
